...
directionalLight.shadow.normalBias = 0.027; // Controls how precise the shadow is
directionalLight.shadow.bias = 0.004; // Controls how close to the edge of the shadow the shadow is

// Controls how precise the shadow is
...
// texture loader loads by default with linear color space, but textures are in sRGB color space
...
// Tone mapping
renderer.toneMapping = THREE.ReinhardToneMapping; // Probably most realistic
